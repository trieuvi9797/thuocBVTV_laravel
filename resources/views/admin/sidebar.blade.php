            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-5" class="collapse submenu submenu-5" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="notifications.html">Danh sách tài khoản</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="account.html">Thêm tài khoản</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="settings.html">Reset Password</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="settings.html">Xóa tài khoản</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
            </ul>
